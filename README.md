...
- **SegFormer resnet101 cityscapes model  (Hugging Face model)**: (https://huggingface.co/nvidia/segformer-b5-finetuned-cityscapes-1024-1024)]([https://huggingface.co/docs/transformers/model_doc/segformer](https://huggingface.co/nvidia/segformer-b5-finetuned-cityscapes-1024-1024))
